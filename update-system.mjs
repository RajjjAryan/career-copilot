...
/**
 * update-system.mjs — Safe auto-updater for career-copilot
 *
...
const CANONICAL_REPO = 'https://github.com/RajjjAryan/career-copilot.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/RajjjAryan/career-copilot/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/RajjjAryan/career-copilot/releases/latest';
