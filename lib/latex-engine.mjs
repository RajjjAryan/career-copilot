...
export function reorderItems(lines, parsed, keywords, boostTerms = []) {
  ...
  const REORDER_SECTIONS = [
    ...
    'trabajo', 'proyecto', 'logro', 'experiencia',           // Spanish
    'berufserfahrung', 'projekte', 'erfahrung',              // German
    'expérience', 'projets', 'réalisations',                 // French
    'experiência', 'projetos',                                // Portuguese
  ];
