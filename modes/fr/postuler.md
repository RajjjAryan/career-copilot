...
5. **career-copilot proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/career-copilot contacto` pour du LinkedIn outreach vers le hiring manager
